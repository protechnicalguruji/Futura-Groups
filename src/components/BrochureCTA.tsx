...
export default function BrochureCTA() {
  return (
    <section className="py-24 px-6 md:px-8">
      <div className="max-w-7xl mx-auto bg-accent rounded-[40px] p-8 md:p-16 text-center text-primary">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">Download Our Exclusive Brochure</h2>
