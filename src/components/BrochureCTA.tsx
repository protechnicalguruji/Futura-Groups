...
export default function BrochureCTA() {
  return (
    <section className="py-12 lg:py-16 px-6 md:px-8">
      <div className="max-w-7xl mx-auto bg-accent rounded-[40px] p-6 md:p-16 lg:p-12 text-center text-primary">
            <h2 className="text-2xl md:text-4xl lg:text-3xl font-display font-bold mb-4 md:mb-6 leading-tight">Download Our Exclusive Brochure</h2>
            <p className="mb-6 md:mb-10 lg:mb-8 text-base md:text-lg lg:text-base opacity-90">Explore our service portfolio, investment insights, and premium land opportunities.</p>
