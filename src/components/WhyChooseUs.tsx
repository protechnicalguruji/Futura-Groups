  ...
  return (
    <section className="py-12 md:py-24 lg:py-16 bg-background">
      <div className="max-w-7xl mx-auto px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10 md:mb-16 lg:mb-12 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
                <h2 className="text-3xl md:text-5xl lg:text-4xl font-display font-bold text-primary mb-4 md:mb-6">Where Trust Meets Tomorrow</h2>
                <p className="text-lg md:text-xl lg:text-lg text-gray-600 max-w-2xl">We focus on delivering trusted real estate solutions while helping clients make informed long-term property investment decisions in Bengaluru.</p>
            </div>
            <div className="h-64 md:h-80 overflow-hidden rounded-[40px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {reasons.map((item, i) => (
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl lg:text-xl font-bold text-primary mb-2 md:mb-3">{item.title}</h3>
