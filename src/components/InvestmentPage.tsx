  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pt-32 px-6 md:px-8 pb-20">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl lg:text-4xl font-display font-bold text-primary mb-10 lg:mb-8">Investment Opportunities</h1>
        <div className="bg-white/80 backdrop-blur-lg p-6 lg:p-5 rounded-[28px] border border-gray-100 shadow-sm mb-10 lg:mb-8">
          <div className="flex gap-4 mb-6 lg:mb-4 overflow-x-auto pb-4 no-scrollbar">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-6">
            {filtered.map(p => (
                <div key={p.id} className="bg-white rounded-[28px] shadow-sm overflow-hidden border border-gray-100">
                    <div className="h-48 md:h-64 lg:h-56 bg-gray-200" />
