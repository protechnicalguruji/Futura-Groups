  ...
  return (
    <section className="py-12 md:py-24 px-6 md:px-8">
      <div className="max-w-7xl mx-auto bg-white/70 backdrop-blur-lg rounded-[40px] p-6 md:p-16 text-center border border-white/40 shadow-xl">
        <h2 className="text-2xl md:text-4xl font-display font-bold text-primary mb-4 md:mb-6 leading-tight">Stay Updated with Futura Groups</h2>
        <p className="text-sm md:text-base text-gray-600 mb-6 md:mb-10 max-w-lg mx-auto">Subscribe for the latest property listings and market insights in Bengaluru.</p>
