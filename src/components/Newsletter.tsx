...
export default function Newsletter() {
  return (
    <section className="py-24 px-6 md:px-8">
      <div className="max-w-7xl mx-auto bg-white/70 backdrop-blur-lg rounded-[40px] p-8 md:p-16 text-center border border-white/40 shadow-xl">
        <h2 className="text-3xl md:text-4xl font-display font-bold text-primary mb-6">Stay Updated with Elite Estates</h2>
