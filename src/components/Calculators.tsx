  ...
  return (
    <section className="py-12 md:py-20 lg:py-12 bg-background">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <h2 className="text-3xl md:text-4xl lg:text-3xl font-display font-bold text-primary mb-10 md:mb-12 lg:mb-10 text-center">Financial Tools</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-6">
          <motion.div whileHover={{ y: -5 }} className="bg-surface p-6 md:p-7 lg:p-5 rounded-[28px] border border-white shadow-lg hover:shadow-2xl transition-all">
            <h3 className="text-xl md:text-xl lg:text-lg font-bold mb-4 md:mb-5 lg:mb-4">EMI Calculator</h3>
          ...
          <motion.div whileHover={{ y: -5 }} className="bg-surface p-6 md:p-7 rounded-[28px] border border-white shadow-lg hover:shadow-2xl transition-all">
            <h3 className="text-xl md:text-xl font-bold mb-4 md:mb-5">ROI Calculator</h3>
