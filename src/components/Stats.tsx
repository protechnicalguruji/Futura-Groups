      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 lg:gap-6">
        {stats.map((stat, i) => (
          <motion.div
            ...
            className="bg-white p-4 md:p-7 lg:p-5 rounded-[28px] shadow-sm text-center border border-gray-100"
          >
            <div className="text-2xl md:text-3xl lg:text-2xl font-bold text-primary mb-1 md:mb-2">
