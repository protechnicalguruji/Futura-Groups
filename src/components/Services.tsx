...
export default function Services() {
  return (
    <section id="services" className="py-12 md:py-20 lg:py-12 bg-background">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <h2 className="text-3xl md:text-4xl lg:text-3xl font-display font-bold text-primary mb-10 md:mb-12 lg:mb-10 text-center">Premium Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-5">
          {services.map((s, i) => (
            <motion.div key={i} whileHover={{ y: -5 }} className="bg-surface p-6 md:p-7 lg:p-5 rounded-[28px] border border-gray-100 shadow-sm flex flex-col gap-3 md:gap-4 lg:gap-3 group">
              <s.icon className="text-accent" size={24} />
              <h3 className="text-xl md:text-xl lg:text-lg font-bold text-primary">{s.title}</h3>
